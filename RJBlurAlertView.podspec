...
Pod::Spec.new do |s|
  ...
  s.description  = <<-DESC
                   A longer description of RJBlurAlertView in Markdown format.
  ...
  # Or just: s.author    = "rayjune"
  # s.authors            = { "rayjune" => "wuleijun8@gmail.com" }
  # s.social_media_url   = "http://twitter.com/rayjune"
  ...
  s.source       = { :git => "https://github.com/wuleijun/RJBlurAlertView.git", :tag => "0.0.1" }
